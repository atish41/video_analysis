...
2. Provide a brief, descriptive analysis of what you observe
...
Your response should be clear, concise, and informative, highlighting the most notable aspects of the image or video.
"""
...
def analyze_media(media_type, media_url, text_msg=""):
    ...
    try:
        if media_type == 'video':
            ...
            video_frames = fetch_and_preprocess_video(media_url)
            ...
            image_part = fetch_and_preprocess_image(media_url)
